        ...
        <header>
          <Navbar className="navbar-custom" variant="dark" expand="lg">
            <Container>
              ...
              <LinkContainer to="/">
                <Navbar.Brand className="brand-name">QrCart</Navbar.Brand>
              </LinkContainer>
        ...
        <main>
          <Container className="mt-3">
            <Routes>
              ...
              <Route path="/qr-scanner" element={<ProductQRCodeScreen />} />
...
//     <Router>
//       {/* Other routes */}
//       {/* <Route path="/product/qr-scan" element={<ProductQRCodeScreen />} /> */}
//       <Route path="/qr-scanner" element={<ProductQRCodeScreen />} />
//     </Router>
//   );
// }
